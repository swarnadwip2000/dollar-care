...
class ManageClinicEditTransformer extends TransformerAbstract
{
    ...
    public function transform(ClinicDetails $clinic)
    {
        return [
            ...
            'clinic_slots'           => $clinic->clinic_slots()->select('id', 'clinic_detail_id', 'slot_date', 'slot_start_time', 'slot_end_time')->get(),
        ];
    }
