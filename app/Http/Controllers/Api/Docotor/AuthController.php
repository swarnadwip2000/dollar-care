...
class AuthController extends Controller
{
    ...
    /**
     * Login Api
     * @bodyParam email string required The email of the Doctor. Example: john@yopmail.com
     * @bodyParam password string required The password of the Doctor. Example: 12345678
     * @response 200{
     *  "status": true,
     *  "statusCode": 200,
    ...
    public function login(Request $request)
    {
        ...
        try {
            if (Auth::attempt(['email' => $request->email, 'password' => $request->password])) {
                ...
                if ($user->hasRole('DOCTOR') && $user->status == 1) {
    ...
    /**
     * Register Api
     * @bodyParam name string required The name of the doctor. Example: John Doe
     * @bodyParam email string required The email of the doctor. Example: john@yopmail.com
     * @bodyParam gender string required. Example: Male,Female,Other
     * @bodyParam phone numeric required The phone of the doctor. Example: 9876543210
     * @bodyParam location string The name of the doctor. Example: John Doe
     * @bodyParam password string required The password of the doctor. Example: 12345678
     * @bodyParam confirm_password string required The confirm_password of the doctor. Example: 12345678
     *  
     * @response 200 {
     *   "status": true,
     *  "statusCode": 200,
