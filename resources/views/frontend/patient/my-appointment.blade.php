                                                            ...
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-xl-3 col-md-6 col-12">
                                                                    <div class="app-time app-time-2">
                                                                        ...
                                                                        <p>{{ date('D, d M Y',strtotime($pastAppontment['appointment_date'])) }} {{$pastAppontment['appointment_time']  }}</p>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-2 col-md-6 col-12">
                                                                    <div class="{{ ($pastAppontment['appointment_status'] == 'Done') ? 'status' : 'status-2' }}">
                                                                        <div class="app-time app-time-2">
                                                                            <h3>Status</h3>
                                                                            <h2>{{  $pastAppontment['appointment_status'] }}</h2>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
